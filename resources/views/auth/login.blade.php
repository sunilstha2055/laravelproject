...
<html lang="en">
  <head>
    ...
    <title>Company Template | Login</title>
              ...
              <form action="{{ route('login') }}" method="POST">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email" name="email" :value="old('email')" required autofocus class="form-control input-lg"  aria-describedby="emailHelp" placeholder="Email">
                  </div>
