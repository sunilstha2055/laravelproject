                ...
                <div class="todo-single-item mb-0" id="todo-input">
                    <form class="todo-form">
                        <div class="input-group mb-0">
                            <input type="text" class="form-control border-right-0" placeholder="Add Todo"
                                required="" autofocus>
                            <div class="input-group-append ml-0">
                                <button class="input-group-text border-0 btn bg-primary" type="submit">
                                    <?xml version="1.0"?>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 448 448"
                                        width="18" class="">
                                        <g>
                                            <path
            ...
            <div class="card-body compact-to-do-list" data-simplebar style="height: 450px;">
                <div class="todo-list" id="todo-list">
                    ...
                    <div class="todo-single-item d-flex flex-row justify-content-between alert alert-dismissible fade show"
                        role="alert">
                        <i class="mdi"></i>
                        <span>Add new Google Analytics code to all main files sed auctor lacus in
                            sem interdum, ac gravida tortor elementum. Cras magna enim.</span>
            ...
            <div class="card-body py-0">
                <div class="media d-flex mb-5">
                    ...
                    <div class="media-body align-self-center">
                        ...
                        <p class="float-md-right"><span class="text-dark mr-2">20</span>Sales
                        </p>
                ...
                <div class="media d-flex mb-5">
                    ...
                    <div class="media-body align-self-center">
                        ...
                        <p class="float-md-right"><span class="text-dark mr-2">10</span>Sales
                        </p>
                        <p class="d-none d-md-block">Statement belting with double-turnlock
                            hardware adds “swagger” to a simple.</p>
                        <p class="mb-0">
